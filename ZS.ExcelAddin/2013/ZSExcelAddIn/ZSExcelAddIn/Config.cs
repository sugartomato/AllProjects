...
namespace ZSExcelAddIn
{
    ...
    public class Config
    {
        ...
        #region 聚光灯窗体配置
        public static Dictionary<String, Controls.frmFocus> FocusForms = new Dictionary<string, Controls.frmFocus>();
        ...
        private static System.Drawing.Color _propSpotlightColor = System.Drawing.Color.LightGreen;
        public static System.Drawing.Color SpotlightColor {
            get
            {
                String xPath = "/DHD/SpotlightColor";
                XmlNode node = GetNode(xPath);
                if (node == null)
                {
                    node = XmlDoc.CreateNode(XmlNodeType.Element, "SpotlightColor", "");
                    XmlDoc.DocumentElement.AppendChild(node);
                }
                String st = GetNodeValue(xPath);
                if (!String.IsNullOrEmpty(st))
                {
                    _propSpotlightColor = System.Drawing.Color.FromName(st);
                }
                return _propSpotlightColor;
            }
            set
            {
                String xPath = "/DHD/SpotlightColor";
                ...
                _propSpotlightColor = value;
                SetNodeValue(xPath, _propSpotlightColor.Name);
            }
        }
        public static Boolean ShowSpotlight
        {
            get
            {
                Boolean t = false;
                Boolean.TryParse(GetNodeValue("/DHD/ShowSpotlight"), out t);
                return t;
            }
            set
            {
                SetNodeValue("/DHD/ShowSpotlight", value.ToString());
            }
        }
        ...
        private static String ConfigFilePath
        {
            get
            {
                ...
                path = System.IO.Path.GetDirectoryName(path) + "\\Config.xml";
